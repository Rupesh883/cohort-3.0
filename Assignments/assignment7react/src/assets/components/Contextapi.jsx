...
export function ContextProvider({ children }) {
 ...
 async function fetchProducts(){
  ...
  // console.log("im printing from context",allUserData)
  
    return (
    <MyContext.Provider value={{allUserData, setAllUserData,loginData, setLoginData,products,setProducts,cartOpen,setCartOpen,filter,setFilter,cartItems,setCArtItems}}>
      {children}
    </MyContext.Provider>
  );
